	...
	if (!empty($prep_artikul)) { 
		...
		?>		
					<tr><td>
						...
						<td>
						<a href="index.php?proizvoditel=<?php echo htmlentities($stroka_bazy["proizvoditel"]);?>&crossnum=<?php echo htmlentities($stroka_bazy["crossnum"]);?>&nalichie=da">Перейти к наличию</a>
						</td>
						<td>
						<a href="index.php?proizvoditel=<?php echo htmlentities($stroka_bazy["proizvoditel"]);?>&crossnum=<?php echo htmlentities($stroka_bazy["crossnum"]);?>">Перейти ко всей номенклатуре</a>
						</td>	
					</tr>						
