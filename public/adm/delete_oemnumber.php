...
<?php	
		...
		if (isset($_POST['delete'])){
			...
			$query = "DELETE FROM {$safe_brand}_oem WHERE id = {$safe_id} LIMIT 1";
			$result = mysqli_query($connection, $query);
			
			if ($result && mysqli_affected_rows($connection) == 1) {
				// Success
					$_SESSION["message"] = "Oemstroka deleted.";
					// redirect_to("tecdoc_poisk_admin.php");		
			}   else {
					// Неудача
					$_SESSION["message"] = "Oemstroka deletion failed."."(SQL state: ".mysqli_sqlstate($connection)."). Error: ".mysqli_errno($connection).". ".mysqli_error($connection);
					// redirect_to("tecdoc_poisk_admin.php");		
				}		
		}	
...
?>	
	<div id="form">
	<form id="delete_oemnumber" name="delete_oemnumber" method="post" action="delete_oemnumber.php">
		<label></label><br/><br/>
		     id: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
